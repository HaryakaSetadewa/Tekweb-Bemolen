    ...
    <div class="grid grid-cols-7 gap-6 xl:grid-cols-2 pb-5">
      <div class="p-2  mt-6 xl:mt-1 rounded-lg">
        ...
        <div class="card-body flex items-center"> 
          ...
          <a href="{{ route('adminpackage.create') }}" class="font-semibold text-sm ml-2 text-primary hover:text-blue-600 transition-colors">Tambahkan</a>
      </div>      
              ...
              <tbody>
                  ...
                  <tr class="bg-gray-400 border-b dark:bg-gray-800 dark:border-gray-700">
                    <td class="px-6 py-4">
                      ...
                      <td class="px-6 py-4">
                          <a href="{{ route('adminpackage.edit', $item->package_id) }}"  class="font-medium text-yellow-500 dark:text-blue-500 hover:underline mr-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                              <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                              <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                            </svg>
                          </a>
                          <form action="{{ route('adminpackage.destroy', $item->package_id) }}" class="font-medium text-red-600 dark:text-blue-500 hover:underline mr-2
                            " method="POST">
                              @csrf @method('DELETE')
