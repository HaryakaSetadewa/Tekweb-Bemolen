...
<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
    ...
    <div class="flex-none w-56 flex flex-row items-center">
      ...
      <strong class="capitalize ml-1 flex-1">BEMOLEN</strong>
        ...
        <div class="dropdown relative md:static">
          ...
          <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
            ...
            <div class="ml-2 capitalize flex ">
              <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none">Bemolen</h1>
...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div class="bg-gray-100 flex-1 p-6 md:mt-16"> 
    ...
    <!-- update section -->
    <div class="card bg-gray-500 border-gray-500 shadow-md text-white overflow-hidden">
      <div class="card-body flex flex-row items-center justify-center" style="background-size: 50%;"> <!-- Added style for background-size -->
          <h1 class="text-center text-2xl "><b>KERANJANG BARANG</b></h1>
      </div>
  </div>
...
<?php /**PATH D:\CRUD LARAVEL\breeze\breeze\resources\views/components/admin-layout.blade.php ENDPATH**/ ?>