...
<?php $component->withAttributes([]); ?>
   <body class="bg-gray-100 p-6">
    <h2 class="text-center pt-10 text-3xl font-bold tracking-tight text-gray-900">Detail Pertunjukkan <span class="text-purple-700">Kecak Gianyar</span></h2>
    <div class="max-w-md mx-auto mt-6 bg-white rounded-lg overflow-hidden">
        ...
        <div class="">
            <p class=""><strong>Lokasi:</strong> Kota Gianyar, Bali (Pura Dalem Puri)</p>
            <p class=""><strong>Waktu:</strong> 17.00 WITA - 20.00 WITA (Saat matahari terbenam)</p>

            <h3 class="py-2 text-xl font-bold">Rp. 120.000</h3>
            <p class="mb-2 mt-2">
                Banyak pagelaran seni di Gianyar yang menghadirkan tari Kecak sebagai bagian dari acara budaya dan pariwisata. Salah satu tempat yang sering menjadi lokasi pertunjukan tari Kecak di Gianyar adalah Pura Dalem Puri, di Desa Batuan. Biasanya, pertunjukan ini diadakan di area terbuka, menghadirkan penampilan yang menarik dengan latar belakang kuil dan suasana yang khas.
            </p>
...
<?php endif; ?><?php /**PATH C:\Users\ASUS\Documents\Ilmu komputer (tugas)\tugas smtr 3\breeze\resources\views/frontpage/notflix.blade.php ENDPATH**/ ?>