             ...
             <div class="p-6 bg-white border-b border-gray-200">
                <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                   ...
                   <section>
                      <div class="md:flex font-sans pt-8">
                         ...
                         <form class="p-6">
                            <div class="flex flex-wrap">
                               <h1 class="flex-auto font-bold text-slate-900"> Kecak Fire Gianyar</h1>
                            ...
                            <div class="flex items-baseline mt-4 mb-6 pb-6 border-b border-slate-200">
                              Di Gianyar, tari Kecak adalah bagian penting dari warisan budaya dan seni pertunjukan. Gianyar dikenal sebagai pusat kegiatan seni dan kebudayaan di Bali, dan tari Kecak sering dipertunjukkan di berbagai tempat di wilayah ini.
                               </div>
                      ...
                      <div class="md:flex font-sans pt-8">
                         <div class="md:shrink-0">
                            <img src="<?php echo e(asset('images/barong.jpg')); ?>" alt="" class=" md:h-full md:w-56 inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
                         </div>
                         <form class="p-6">
                            <div class="flex flex-wrap">
                      ...
                      <div class="md:flex font-sans pt-8">
                        <div class="md:shrink-0">
                           <img src="<?php echo e(asset('images/uluwatu.jpg')); ?>" alt="" class=" md:h-full md:w-56 inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
                        </div>
                        <form class="p-6">
                           <div class="flex flex-wrap">
...
<?php endif; ?>
<?php /**PATH C:\Users\ASUS\Documents\Ilmu komputer (tugas)\tugas smtr 3\breeze\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>